...
async def full_collection_workflow(reset_vectordb: bool = False, create_backup: bool = True, skip_confirmation: bool = False):
    ...
    try:
        ...
        # 벡터DB 초기화 설정 가져오기
        try:
            from large_scale_config import VECTOR_DB_CONFIG, RESET_VECTORDB as ENV_RESET_VECTORDB, SKIP_VECTORDB_CONFIRMATION
    ...
    if RESET_VECTORDB:
        from core.vectordb import QdrantAdapter, COLLECTION_NAME, FAQ_COLLECTION_NAME
