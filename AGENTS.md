...
> **Note**: The backend logic described in this document has been migrated to the `project-a-backend` repository. This repository (`project-a`) now focuses on the Frontend (Freshdesk App).
